...
wordled start --rollmint.aggregator true --with_fraud --rollmint.da_layer celestia --rollmint.da_config='{"base_url":"http://138.197.230.80:26659","fee":6000,"timeout":60000000000,"gas_limit":6000000}' --rollmint.namespace_id $NAMESPACE_ID --rollmint.da_start_height $DA_BLOCK_HEIGHT --rollmint.experimental_insecure_fraud_proofs
